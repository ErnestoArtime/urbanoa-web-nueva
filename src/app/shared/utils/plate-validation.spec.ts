...
describe('plate validation', () => {
  ...
  it('allows foreign plates with letters, numbers and hyphens up to ten characters', () => {
    expect(isValidPlate('ABC', true)).toBeTrue();
  ...
  it('rejects foreign plates over ten characters or with other symbols', () => {
