  ...
  template:`
    <main class="auth-page register-page">
      <section class="register-panel">
        <img src="/assets/brand/arinpark-logo.png" alt="ArinPark" class="register-logo" />
        <header><a routerLink="/auth/login" aria-label="Volver">←</a><div><h1>Registro</h1><p>Crea tu cuenta ArinPark</p></div></header>
        <div class="form-grid">
