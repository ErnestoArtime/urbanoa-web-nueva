...
@Component({
  ...
  `,
  styles:[`
    .register-page{justify-content:center;background:var(--color-background)}.register-panel{width:min(100%,520px);padding:1.7rem 2.2rem;border:1px solid var(--color-border);border-radius:22px;background:var(--color-surface);box-shadow:var(--shadow-md)}.register-logo{display:block;width:190px;max-width:60%;margin:0 auto 1.25rem}.register-panel header{display:flex;align-items:center;gap:1rem;margin-bottom:1rem}.register-panel header>a{font-size: var(--text-2xl)}.register-panel h1{font-size: var(--text-2xl)}.register-panel header p{color:var(--color-text-muted)}.outlined-field{position:relative;display:block;margin:.85rem 0}.outlined-field span{position:absolute;z-index:1;top:-.55rem;left:.8rem;padding:0 .35rem;background:var(--color-surface);color:var(--color-primary);font-size: var(--text-xs)}.outlined-field input{width:100%;min-height:52px;padding:.8rem 1rem;border:1px solid var(--color-primary);border-radius:6px;background:transparent;font:inherit}.foreign-check,.terms-check{display:flex;align-items:flex-start;gap:.55rem;color:var(--color-text-muted);font-size: var(--text-sm)}.foreign-check{margin-top:-.25rem}.terms-check{margin:1rem 0}.terms-check input{margin-top:.2rem}.continue-button{min-height:50px}.login-link{text-align:center;margin-top:1rem;color:var(--color-text-muted)}@media(max-width:560px){.register-panel{padding:1rem;border:0;box-shadow:none;background:transparent}.outlined-field span{background:var(--color-background)}}
  `],
})
