...
@Component({
  ...
  template: `
    ...
    <div class="page flow-page">
      ...
      <div class="selection-summary card">
        ...
        <div><strong>{{ query.street }}</strong><p>{{ query.zone }} · {{ query.cityName }}</p><small>{{ 'parking.tickets.vehicle' | translate:{plate: query.plate} }}</small></div>
      </div>
  ...
  `,
  styles: [`
    .flow-page{max-width:760px}.back-link{display:inline-block;margin-bottom:1rem}.flow-step{color:var(--color-primary);font-size: var(--text-xs);font-weight: var(--font-extra);text-transform:uppercase}.selection-summary{display:flex;gap:.8rem;margin:1rem 0}.zone-color{width:8px;border-radius:99px}.selection-summary p,.selection-summary small{color:var(--color-text-muted)}.tariff-list{display:grid;gap:.8rem}.ticket-option{position:relative;display:grid;gap:.8rem;overflow:hidden;padding:1rem;border:1px solid var(--color-border);border-radius:14px;background:var(--color-surface);color:inherit;box-shadow:var(--shadow-sm)}.ticket-option:hover{text-decoration:none;box-shadow:var(--shadow-md)}.ticket-color{position:absolute;top:0;right:0;left:0;height:6px}.ticket-option-head{display:flex;justify-content:space-between;gap:1rem;padding-top:.2rem}.ticket-option-head small,.ticket-option-head p{color:var(--color-text-muted);font-size: var(--text-xs)}.ticket-option-head h2{margin:.12rem 0;font-size: var(--text-base)}.ticket-option-head>strong{align-self:center;color:var(--color-primary);white-space:nowrap}.ticket-meta{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;padding:.65rem 0;border-block:1px dashed var(--color-border)}.ticket-meta span{display:flex;min-width:0;flex-direction:column}.ticket-meta small{color:var(--color-text-muted);font-size: var(--text-2xs)}.ticket-meta strong{overflow:hidden;font-size: var(--text-xs);text-overflow:ellipsis;white-space:nowrap}.ticket-action{justify-self:end;color:var(--color-primary);font-size: var(--text-sm);font-weight: var(--font-extra)}.ticket-action b{font-size: var(--text-base)}
  `],
})
