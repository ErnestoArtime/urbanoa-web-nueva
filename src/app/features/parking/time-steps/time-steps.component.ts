...
@Component({
  ...
  styles: [`
    ...
    .time-line{display:grid;grid-template-columns:auto 1fr auto 1fr auto;align-items:center;gap:.65rem;text-align:center}.time-line div{display:flex;flex-direction:column}.time-line small{color:var(--color-text-muted)}.time-line strong{font-size: var(--text-lg)}.line{height:1px;background:var(--color-border)}.duration-pill{padding:.45rem .7rem;border:1px solid var(--color-border);border-radius:10px;font-weight: var(--font-bold);background:var(--color-background)}
    .time-selector{display:flex;align-items:center;justify-content:center;gap:1.25rem;margin:1.5rem 0}.time-wheel{width:210px;height:210px;padding:11px;border-radius:50%;box-shadow:0 8px 26px rgba(34,105,105,.16);transition:background .25s ease}.wheel-content{height:100%;border-radius:50%;background:var(--color-surface);display:flex;flex-direction:column;align-items:center;justify-content:center;border:1px solid var(--color-border)}.wheel-content small{color:var(--color-text-muted);text-transform:uppercase;font-weight: var(--font-bold)}.wheel-content strong{font-size: var(--text-display);color:var(--color-primary);margin:.2rem 0}.wheel-content span{font-weight: var(--font-extra)}.step-control{width:44px;height:44px;border-radius:50%;border:1px solid var(--color-primary);background:var(--color-surface);color:var(--color-primary);font-size: var(--text-2xl);cursor:pointer}.step-control:disabled{opacity:.3;cursor:not-allowed}
    .step-options{display:flex;flex-wrap:wrap;justify-content:center;gap:.5rem;margin-bottom:1.25rem}.step-options button{border:1px solid var(--color-border);border-radius:999px;background:var(--color-surface);padding:.45rem .75rem;cursor:pointer}.step-options button.active{background:var(--color-primary);border-color:var(--color-primary);color:#fff;font-weight: var(--font-bold)}.price-card{display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem}.price-card span{color:var(--color-text-muted)}.price-card strong{font-size: var(--text-xl);color:var(--color-primary)}
    @media(min-width:960px) and (max-height:950px){.flow-page{padding-top:1rem;padding-bottom:.8rem}.back-link{margin-bottom:.35rem}.page-title{font-size: var(--text-xl)}.page-subtitle{font-size: var(--text-sm)}.context-card{margin:.65rem 0;padding:.75rem}.time-line{padding:.65rem}.time-selector{margin:.7rem 0}.time-wheel{width:168px;height:168px;padding:9px}.wheel-content strong{font-size: var(--text-2xl)}.step-control{width:40px;height:40px}.step-options{margin-bottom:.65rem}.price-card{padding:.65rem;margin-bottom:.55rem}}
