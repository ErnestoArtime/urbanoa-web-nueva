...
export const ACCOUNT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'help', loadComponent: () => import('./web-content/web-content.component').then(m => m.WebContentComponent), data: { title: 'Ayuda', url: 'https://arinpark.gerteksa.eus/Arinpark/ArinparkFAQ-ESP.html' } },
      { path: 'terms-and-conditions', loadComponent: () => import('./web-content/web-content.component').then(m => m.WebContentComponent), data: { title: 'Términos y condiciones', url: 'https://arinpark.gerteksa.eus/arinpark/CU_es.html' } },
      { path: 'privacy-policy', loadComponent: () => import('./web-content/web-content.component').then(m => m.WebContentComponent), data: { title: 'Política de privacidad', url: 'https://arinpark.gerteksa.eus/arinpark/es.html' } },
