...
export const ACCOUNT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { title: 'Ayuda', url: '/external-content/Arinpark/ArinparkFAQ-ESP.html' },
      },
      {
        path: 'terms-and-conditions',
        loadComponent: () => import('./web-content/web-content.component').then((m) => m.WebContentComponent),
        data: { title: 'Términos y condiciones', url: '/external-content/arinpark/CU_es.html' },
      },
      {
        path: 'privacy-policy',
        loadComponent: () => import('./web-content/web-content.component').then((m) => m.WebContentComponent),
        data: { title: 'Política de privacidad', url: '/external-content/arinpark/es.html' },
      },
