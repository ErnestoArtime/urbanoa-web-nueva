    ...
    <div class="page account-static-page">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          ><input class="form-input" [placeholder]="'account.addCard.cardNumber' | translate" />
        </div>
        <div class="form-row">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            ><input class="form-input" [placeholder]="'account.addCard.cvc' | translate" />
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="secure-badge">
        <span>{{ 'account.addCard.securePayment' | translate }}</span
        ><span
