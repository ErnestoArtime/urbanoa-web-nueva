...
export class AccountMenuComponent {
  ...
  private readonly iconByKey: Record<string, string> = {
    ...
    share:
      'M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7a2.5 2.5 0 0 0 0-1.39l7-4.11A3 3 0 1 0 15 5a3 3 0 0 0 .04.48l-7 4.12a3 3 0 1 0 0 4.8l7.13 4.2A3 3 0 1 0 18 16.08z',
    ...
    privacy:
      'M12 2 4 5v6c0 5.25 3.4 10.18 8 11 4.6-.82 8-5.75 8-11V5l-8-3zm0 10.5a1.75 1.75 0 1 1 0-3.5 1.75 1.75 0 0 1 0 3.5zM12 18c-1.8 0-3.38-.86-4.38-2.2.99-1.34 2.58-2.2 4.38-2.2 1.8 0 3.38.86 4.38 2.2-1 1.34-2.58 2.2-4.38 2.2z',
    support:
      'M11 18h2v2h-2zm1-16C6.48 2 2 6.48 2 12v2h2a2 2 0 0 0 2-2v-2a6 6 0 0 1 12 0v4h-3v-2a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v5h7a2 2 0 0 0 2-2v-1h2v-2c0-5.52-4.48-10-10-10z',
