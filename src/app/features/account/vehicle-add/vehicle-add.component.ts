...
@Component({
  ...
  template: `
    <div class="page account-static-page">
      ...
      <div class="card">
        <div class="form-group"><label>{{ 'account.vehicleAdd.plate' | translate }} <span class="text-error">*</span></label><input class="form-input" [placeholder]="'account.vehicleAdd.plate' | translate"/><small class="form-error">{{ 'account.vehicleAdd.plateRequired' | translate }}</small></div>
        <label class="switch-row"><span>{{ 'account.vehicleAdd.foreignPlate' | translate }}</span><input type="checkbox"/><span class="switch"></span></label>
        <label class="switch-row"><span>{{ 'account.vehicleAdd.favorite' | translate }}</span><input type="checkbox"/><span class="switch"></span></label>
