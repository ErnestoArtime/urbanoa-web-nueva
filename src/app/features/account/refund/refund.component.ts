...
@Component({
  ...
  template: `
    <div class="page account-static-page">
      ...
      <div class="card">
        <p class="text-muted">{{ 'account.refund.availableBalance' | translate }} <strong>{{ wallet.balance }} €</strong></p>
        <div class="form-group"><label>{{ 'account.refund.amount' | translate }}</label><input class="form-input" type="number" /></div>
